      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 items-center">
        <div className="space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            Sou técnico em eletrônica, estudante de Sistemas de Informação e apaixonado por tecnologia. Desenvolvo
            projetos premiados e busco constantemente superar desafios na criação de soluções tecnológicas inovadoras.
          </p>
