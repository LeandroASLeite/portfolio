      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                <h3 className="font-medium">Estagiário em Desenvolvimento Back-End <span className="text-sm text-muted-foreground">(Ago. 2025 – Presente)</span></h3>
                <p className="text-muted-foreground">Ativa Soluções – Santa Rita do Sapucaí, MG</p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <h3 className="font-medium">Estagiário em Desenvolvimento de Software <span className="text-sm text-muted-foreground">(Fev. 2025 – Abr. 2025)</span></h3>
                <p className="text-muted-foreground">Lightera – Santa Rita do Sapucaí, MG</p>
              </div>
              <div className="border-l-4 border-primary pl-4">
                <h3 className="font-medium">Técnico em Eletrônica <span className="text-sm text-muted-foreground">(Nov. 2021 – Abr. 2025)</span></h3>
                <p className="text-muted-foreground">Lightera – Santa Rita do Sapucaí, MG</p>
              </div>
              <div className="border-l-4 border-primary pl-4">
